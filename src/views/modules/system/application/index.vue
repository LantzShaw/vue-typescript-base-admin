<template>
  <div>
          ...
          <TableAction
            ...
            :actions="[
              ...
              },
              {
                ...
                auth: 'system:application:delete',
              },
            ]"
          />
        </template>
    ...
    <ApplicationModal @register="registerModal" @success="handleSuccess" />
  </div>
</template>
...
<script lang="ts" setup>
  ...
  // 接口
  import { applicationPage, applicationDelete } from '/@/api/system/application';
  import { optionsListBatchApi } from '/@/api/sys/dict';
  // data
  import { dataItemStatusOptions, tfOptions, searchForm, tableColumns } from './application.data';
