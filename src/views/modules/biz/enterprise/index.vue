...
<script lang="ts" setup>
  ...
  import CompanyModal from './EnterpriseModal.vue';
  // 接口
  import { enterprisePage, enterpriseDelete } from '/@/api/biz/enterprise';
  import { optionsListBatchApi } from '/@/api/sys/dict';
  // data
  import { grantTypesOptions, searchForm, tableColumns } from './enterprise.data';
