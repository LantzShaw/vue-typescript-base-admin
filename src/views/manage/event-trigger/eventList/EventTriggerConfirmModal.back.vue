        ...
        <a-row>
          ...
          <a-col :span="24">
            ...
            <a-form-item label="说明内容" name="stepOneRemark">
              <a-textarea
                :readonly="record.stepOneStatus === '150'"
                :rows="4"
          ...
          <a-col :span="24">
            ...
            <a-form-item label="说明内容" name="stepTwoRemark">
              <a-textarea
                :readonly="record.stepTwoStatus === '150'"
                :rows="4"
          ...
          <a-col :span="24">
            ...
            <a-form-item label="说明内容" name="stepThreeRemark">
              <a-textarea
                :readonly="record.stepThreeStatus === '150'"
                :rows="4"
          ...
          <a-col :span="24">
            ...
            <a-form-item label="说明内容" name="stepFourRemark">
              <a-textarea
                :readonly="record.stepFourStatus === '150'"
                :rows="4"
          ...
          <a-col :span="24">
            ...
            <a-form-item label="说明内容" name="stepFiveRemark">
              <a-textarea
                :readonly="record.stepFiveStatus === '150'"
                :rows="4"
          ...
          <a-col :span="24">
            ...
            <a-form-item label="说明内容" name="stepSixRemark">
              <a-textarea
                :readonly="record.stepSixStatus === '150'"
                :rows="4"
          ...
          <a-col :span="24">
            ...
            <a-form-item label="说明内容" name="stepSevenRemark">
              <a-textarea
                :readonly="record.stepSevenStatus === '150'"
                :rows="4"
          ...
          <a-col :span="24">
            ...
            <a-form-item label="说明内容" name="stepEightRemark">
              <a-textarea
                :readonly="record.stepEightStatus === '850'"
                :rows="4"
          ...
          <!-- <a-col :span="24">
            <StepAction
              ...
              :current-step="record.stepEightStatus"
            />
            <a-button type="primary" @click="handleSubmitAll">全部提交</a-button>
            <a-button type="primary" @click="handleSubmitAll">全部通过</a-button>
          </a-col> -->
        </a-row>
      </a-form>
    </div>
