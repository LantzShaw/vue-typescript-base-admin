<template>
  <BasicModal @register="register" title="导入溯源" @ok="handleSubmit">
    <div class="m-1">
...
<script lang="ts">
  ...
  // 接口
  import { sensorTraceabilityImport } from '/@/api/manage/sensorTraceability';
  ...
  export default defineComponent({
    ...
    setup(_, { emit }) {
      ...
      async function uploadApiByItem(item) {
        try {
          await sensorTraceabilityImport(
            {
              file: item,
            },
